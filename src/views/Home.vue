<template>
  <div class="container">
    <large-list>
      <media-large v-for="data in list" :key="data.title" :data="data" />
    </large-list>
    <episode-list class="container-nested" />
  </div>
</template>
...
import LargeList from "../components/util/LargeList.vue";
import MediaLarge from "../components/util/MediaLarge.vue";
